...
<head>
    ...
    <title>Pictorial Importer</title>
            ...
            <div class="sidebar-links-wrapper">
                <div class="site-title">
                    <div class="site-title-wrapper">
                        <a href="imports.php">Pictorial Importer</a>
                    </div>
                </div>
    ...
    <main class="main">
        <div class="container">
            <div class="wrapper">
                ...
                <form action="save-imports.php" method="post">

                    <input type="hidden" name="reject-these" id="reject-these" value="0">

                    <h1>Pictorial Imports</h1>
                                    ...
                                    <div class='card{$wrongSizeClass}'>
                                        <div class='parent-card-container'>
                                            ...
                                            <div class='desc-container'>
                                                ...
                                                <label>
                                                    <h4>
                                                        <input type='checkbox' name='emp_no[]' value='{$row->emp_no}' class='checkbox'>
